...
if (isset($_POST["Submit"])) {
	...
	elseif (strlen($Title)<2) {
		...
		global $DB;
		$Edit_Post=$_GET['Edit'];
		$Update_Query = "UPDATE admin_panel SET datetime='$DateTime',title='$Title',category='$Category',author='$Admin',image='$Image',post='$Post' 
		WHERE id='$Edit_Post'";
		$Execute = mysqli_query($DB, $Update_Query);
...
<!--Nav Ends here-->
		...
		<div class="col-sm-10">
			...
			?>
				<form action="Edit.php?Edit=<?php echo $Edit_Post; ?>" method="post" enctype="multipart/form-data">
					<fieldset>
